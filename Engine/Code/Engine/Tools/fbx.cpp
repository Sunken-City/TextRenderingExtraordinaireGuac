...
#include "../Math/Vector4Int.hpp"
    ...
    static void GetSkinWeights(SceneImport* import, std::vector<SkinWeight>& skinWeights, const FbxMesh* mesh, std::map<int, FbxNode*>& nodeToJointIndex)
    {
        ...
        for (int i = 0; i < skinWeights.size(); ++i)
        {
            ...
            //If skin-weights were never added, make sure you set it to 1,0m0m0
            //float total weight = weights.x + y + z + w
//             if(totalWeight > 0.0f)
//             {
//             weights /= totalWeight;
//         }
...
//             }
    ...
    static void ImportMesh(SceneImport* import, FbxMesh* mesh, MatrixStack4x4& matrixStack, std::map<int, FbxNode*>& nodeToJointIndex)
    {
        ...
        //Figure out our weighs for all verts before importing any VERTS
        ...
        else
        {
            ...
            //Walk tree up till you reach the noad associated with that joint.
